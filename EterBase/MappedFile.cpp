...
void CMappedFile::LinkOwned(DWORD dwBufSize, void* pvBufData)
{
	m_dwBufLinkSize=dwBufSize;
	m_pbBufLinkData=(BYTE*)pvBufData;
	m_bLinkDataOwned=true;
}
...
void CMappedFile::Destroy()
{
	...
	if (m_bLinkDataOwned && m_pbBufLinkData)
	{
