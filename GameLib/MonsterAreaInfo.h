...
public:
	...
	Vector2		GetMonsterDirVector() { return m_v2Monsterdirection; }
	Vector2		GetTempMonsterPos(DWORD dwIndex);
...
protected:
	...
	std::vector<Vector2> m_TempMonsterPosVector;
};
