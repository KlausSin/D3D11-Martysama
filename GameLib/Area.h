...
class CArea
{
	...
	public:
		...
		static void		SetNightMode(bool bNight);
		static bool		ms_bIsNightTime;
#endif
		...
		void			Render();
		void			RenderVTFBatched();      // VTF batched static object rendering
		void			RenderToShadowMap();
		void			RenderToShadowMapVTF();  // VTF batched shadow rendering
		void			RenderEffect();
		void			RenderCollision();
		void			RenderAmbience();
		void			RenderDungeon();
		void			RenderDungeonVTFBatched();
		void			RenderDungeonShadowVTFBatched();
		void			Refresh();
	...
	protected:
		...
		std::unordered_map<DWORD, DWORD>	m_kRenderedCRCCountMap;  // Fast CRC->count lookup
...
#if defined(__BL_AUTO_LANTERN_EFFECT__)
		std::set<DWORD>									m_kLanternEffectIndices;  // indices of lantern effects for day/night toggle
#endif
