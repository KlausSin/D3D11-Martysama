...
CFlyTarget::CFlyTarget(const Vector3& v3FlyTargetPosition)
{
	__Initialize();
...
{
	m_v3FlyTargetPosition=Vector3(0.0f,0.0f,0.0f);
	m_pFlyTarget=NULL;
	m_eType=TYPE_NONE;
}
...
const Vector3 & CFlyTarget::GetFlyTargetPosition() const
{
