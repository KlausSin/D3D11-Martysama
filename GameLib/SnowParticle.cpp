...
void CSnowParticle::Init(const Vector3 & c_rv3Pos)
{
	...
	m_v3Position.x = c_rv3Pos.x + fDistance*sin((double)ToRadian(fRot));
	m_v3Position.y = c_rv3Pos.y + fDistance*cos((double)ToRadian(fRot));
