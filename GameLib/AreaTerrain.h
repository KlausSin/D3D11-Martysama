...
class CTerrain : public CTerrainImpl, public CGraphicBase
{
	public:
		...
		inline ID3D11ShaderResourceView*	GetMiniMapTexture() { return m_lpMiniMapTexture; }
	...
	protected:
		...
		ID3D11ShaderResourceView*	m_lpMiniMapTexture;
		...
		ID3D11ShaderResourceView*	m_lpMarkedTexture;
