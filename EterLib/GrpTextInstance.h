...
class CGraphicTextInstance
{
	...
	public:
		...
		// Getters for ImGui text rendering
		const Vector3& GetPositionRef() const { return m_v3Position; }
		DWORD GetColor() const { return m_dwTextColor; }
		BYTE GetHAlign() const { return m_hAlign; }
		BYTE GetVAlign() const { return m_vAlign; }
