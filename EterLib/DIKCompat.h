...
/*
 * DIKCompat.h
 * DirectInput Key Code Compatibility Definitions
 *
 * Provides DIK_* constant definitions for backward compatibility with code
 * that was written for DirectInput. These are scan codes that match the
 * original DirectInput definitions.
 *
 * This allows existing code using DIK_* constants to compile without
 * requiring the DirectInput SDK or dinput.h header.
 */

#ifndef DIK_ESCAPE

// Keyboard scan codes (matching DirectInput DIK_* values)
...
#define DIK_OEM_102         0x56    // <> or \| on RT 102-key keyboard
#define DIK_F11             0x57
#define DIK_F12             0x58
...
#define DIK_PREVTRACK       0x90    // Previous Track
...
#define DIK_SYSRQ           0xB7    // Print Screen
...
// Page Up / Page Down alternate names
