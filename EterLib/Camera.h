...
//	protected:
	...
	public:
		//////////////////////////////////////////////////////////////////////////
		//////////////////////////////////////////////////////////////////////////
		void SetAngularAcceleration(Vector3 v3AngularAcceleration) { m_v3AngularAcceleration = v3AngularAcceleration; }
		...
		const Vector3 & GetEye() const		{ return m_v3Eye; }
		const Vector3 & GetTarget() const	{ return m_v3Target; }
		const Vector3 & GetUp() const		{ return m_v3Up; }
		const Vector3 & GetView() const		{ return m_v3View; }
		const Vector3 & GetCross() const	{ return m_v3Cross; }

		const Matrix & GetViewMatrix() const		{ return m_matView; }
		const Matrix & GetInverseViewMatrix() const	{ return m_matInverseView; }
		const Matrix & GetBillboardMatrix()const	{ return m_matBillboard; }
