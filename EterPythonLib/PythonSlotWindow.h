...
namespace UI
{
	...
	class CSlotWindow : public CWindow
	{
		...
		public:
			...
			void SetSlot(DWORD dwIndex, DWORD dwVirtualNumber, BYTE byWidth, BYTE byHeight, CGraphicImage * pImage, Color& diffuseColor);
			...
			void ActivateSlot(DWORD dwIndex, const Color & color);
