...
PyObject* appGetImageInfo(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (stbi_info(szFileName, &width, &height, &channels))
	{
		canLoad = TRUE;
	}
...
PyObject * apptestSetSpecularColor(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (!PyTuple_GetFloat(poArgs, 2, &fb))
		return Py_BuildException();
	g_fSpecularColor = Color(fr, fg, fb, 1.0f);
	return Py_BuildNone();
}
...
PyObject * appOpenTextFile(PyObject * poSelf, PyObject * poArgs)
{
	...
	return Py_BuildValue("L", (long long)pTextLineLoader);
}

PyObject * appCloseTextFile(PyObject * poSelf, PyObject * poArgs)
{
	long long iHandle;
	if (!PyTuple_GetLongLong(poArgs, 0, &iHandle))
		return Py_BuildException();
...
void initapp()
{
...
#if 0 // ENABLE_POST_PROCESSING - Re-enable when ready to expose to Python
		// Post-processing effects control
		{ "SetBloomEnabled",			appSetBloomEnabled,				METH_VARARGS },
		{ "SetHDREnabled",				appSetHDREnabled,				METH_VARARGS },
		{ "SetSSAOEnabled",				appSetSSAOEnabled,				METH_VARARGS },
		{ "SetOutlineEnabled",			appSetOutlineEnabled,			METH_VARARGS },
		{ "SetMotionBlurEnabled",		appSetMotionBlurEnabled,		METH_VARARGS },
		{ "SetBloomParams",				appSetBloomParams,				METH_VARARGS },
		{ "SetHDRParams",				appSetHDRParams,				METH_VARARGS },
		{ "IsBloomEnabled",				appIsBloomEnabled,				METH_VARARGS },
		{ "IsHDREnabled",				appIsHDREnabled,				METH_VARARGS },
		{ "IsSSAOEnabled",				appIsSSAOEnabled,				METH_VARARGS },
		{ "IsOutlineEnabled",			appIsOutlineEnabled,			METH_VARARGS },
		{ "IsMotionBlurEnabled",		appIsMotionBlurEnabled,			METH_VARARGS },
		{ "SetFXAAEnabled",				appSetFXAAEnabled,				METH_VARARGS },
		{ "IsFXAAEnabled",				appIsFXAAEnabled,				METH_VARARGS },
		{ "SetVolumetricLightEnabled",	appSetVolumetricLightEnabled,	METH_VARARGS },
		{ "IsVolumetricLightEnabled",	appIsVolumetricLightEnabled,	METH_VARARGS },
		{ "SetVolumetricLightParams",	appSetVolumetricLightParams,	METH_VARARGS },
		{ "SetVolumetricLightColor",	appSetVolumetricLightColor,		METH_VARARGS },
#endif
		{ NULL, NULL },
	};
	...
	PyModule_AddIntConstant(poModule, "__BL_FOG_FIX__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_FOG_FIX__", false);
#endif
