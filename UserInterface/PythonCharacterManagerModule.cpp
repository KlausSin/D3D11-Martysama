...
PyObject* chrmgrGetCulledCount(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonCharacterManager::GetCulledCount());
}

PyObject* chrmgrGetRenderedCount(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonCharacterManager::GetRenderedCount());
}

PyObject* chrmgrGetTotalCount(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonCharacterManager::GetTotalCount());
}
#endif

#ifdef ENABLE_CHAR_RENDER_LIMIT
PyObject* chrmgrSetCharacterRenderLimit(PyObject* poSelf, PyObject* poArgs)
{
	int iLimit;
	if (!PyTuple_GetInteger(poArgs, 0, &iLimit))
		return Py_BadArgument();
	
	CPythonCharacterManager::SetRenderLimit(iLimit);
	return Py_BuildNone();
}

PyObject* chrmgrGetCharacterRenderLimit(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonCharacterManager::GetRenderLimit());
}

PyObject* chrmgrGetCharacterRenderCount(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("ii", 
		CPythonCharacterManager::GetRenderedCount(),
		CPythonCharacterManager::GetSkippedByLimit());
}
#endif

#ifdef ENABLE_EFFECT_LIMIT
#include "../EffectLib/EffectManager.h"
PyObject* chrmgrSetEffectInstanceLimit(PyObject* poSelf, PyObject* poArgs)
{
	int iLimit;
	if (!PyTuple_GetInteger(poArgs, 0, &iLimit))
		return Py_BadArgument();
	
	CEffectManager::SetEffectLimit(iLimit);
	return Py_BuildNone();
}

PyObject* chrmgrGetEffectInstanceCount(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("ii",
		CEffectManager::GetActiveEffectCount(),
		CEffectManager::GetEffectLimit());
}
#endif

#ifdef ENABLE_RENDER_MODE_GROUPING
PyObject* chrmgrGetRenderModeStats(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("iiii",
		CPythonCharacterManager::GetRenderModeNormalCount(),
		CPythonCharacterManager::GetRenderModeBlendCount(),
		CPythonCharacterManager::GetRenderModeAddCount(),
		CPythonCharacterManager::GetRenderModeModulateCount());
}
#endif
...
#ifdef ENABLE_FRUSTUM_CULLING
		{ "GetCulledCount",				chrmgrGetCulledCount,					METH_VARARGS },
		{ "GetRenderedCount",			chrmgrGetRenderedCount,					METH_VARARGS },
		{ "GetTotalCount",				chrmgrGetTotalCount,					METH_VARARGS },
#endif

#ifdef ENABLE_CHAR_RENDER_LIMIT
		{ "SetCharacterRenderLimit",	chrmgrSetCharacterRenderLimit,			METH_VARARGS },
		{ "GetCharacterRenderLimit",	chrmgrGetCharacterRenderLimit,			METH_VARARGS },
		{ "GetCharacterRenderCount",	chrmgrGetCharacterRenderCount,			METH_VARARGS },
#endif

#ifdef ENABLE_EFFECT_LIMIT
		{ "SetEffectInstanceLimit",		chrmgrSetEffectInstanceLimit,			METH_VARARGS },
		{ "GetEffectInstanceCount",		chrmgrGetEffectInstanceCount,			METH_VARARGS },
#endif

#ifdef ENABLE_RENDER_MODE_GROUPING
		{ "GetRenderModeStats",			chrmgrGetRenderModeStats,				METH_VARARGS },
#endif
