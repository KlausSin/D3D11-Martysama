...
PyObject * backgroundSetGodRaysEnabled(PyObject * poSelf, PyObject * poArgs)
{
	int bEnabled;
	if (!PyTuple_GetInteger(poArgs, 0, &bEnabled))
		return Py_BadArgument();
	...
	{
		CMapOutdoor& rkMap = rkBG.GetMapOutdoorRef();
		rkMap.SetGodRaysEnabled(bEnabled != 0);
	}
	return Py_BuildNone();
}

PyObject * backgroundSetGodRaysIntensity(PyObject * poSelf, PyObject * poArgs)
{
	float fIntensity;
	...
	{
		CMapOutdoor& rkMap = rkBG.GetMapOutdoorRef();
		rkMap.SetGodRaysIntensity(fIntensity);
	}
	return Py_BuildNone();
}

PyObject * backgroundSetGodRaysParams(PyObject * poSelf, PyObject * poArgs)
{
	float fDensity, fDecay, fExposure;
	if (!PyTuple_GetFloat(poArgs, 0, &fDensity))
		return Py_BadArgument();
	if (!PyTuple_GetFloat(poArgs, 1, &fDecay))
		return Py_BadArgument();
	if (!PyTuple_GetFloat(poArgs, 2, &fExposure))
		return Py_BadArgument();
	...
	{
		CMapOutdoor& rkMap = rkBG.GetMapOutdoorRef();
		rkMap.SetGodRaysParams(fDensity, fDecay, fExposure);
	}
	return Py_BuildNone();
}
...
void initBackground()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetGodRaysEnabled",					backgroundSetGodRaysEnabled,				METH_VARARGS },
		{ "SetGodRaysIntensity",				backgroundSetGodRaysIntensity,				METH_VARARGS },
		{ "SetGodRaysParams",					backgroundSetGodRaysParams,					METH_VARARGS },
