...
class CPythonApplication : public CMSApplication, public CInputKeyboard, public IAbstractApplication
{
	...
	protected:
		// Media Foundation video playback (replaces DirectShow)
		IMFSourceReader*		m_pSourceReader;			// MF Source Reader for video frames
		BYTE*					m_pCaptureBuffer;
		LONG					m_lBufferSize;
		CGraphicImageTexture*	m_pLogoTex;
		bool					m_bLogoError;
		bool					m_bLogoPlay;
		UINT32					m_nVideoWidth;
		UINT32					m_nVideoHeight;
