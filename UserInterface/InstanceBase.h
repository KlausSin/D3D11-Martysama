...
class CInstanceBase
{
	...
	public:
		...
		static const Color& GetIndexedNameColor(UINT eNameColor);
	...
	public:
		...
		void					RenderWithoutStateSetup();
		void					BlendRenderWithoutStateSetup();
		float					GetAlphaValue();
	...
	public:
		float					m_fCachedDistanceFromMain;
		DWORD					m_dwCachedDistanceFrame;

		DWORD					m_dwStoneDeformFramesLeft = 5;
